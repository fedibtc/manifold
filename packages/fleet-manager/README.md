...
[`v0.11.1-fedi15`](https://github.com/fedibtc/fedimint/releases/tag/v0.11.1-fedi15)
(commit `4c70c0e54f2f6a25df518c5082ac5a81d7a46d70`), whose release identity is
carried as
`0.11.1-fedi15` (the `FEDIMINTD_VERSION_0_1` constant and the image's
