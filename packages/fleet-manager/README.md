...
[`v0.11.1-fedi18`](https://github.com/fedibtc/fedimint/tree/v0.11.1-fedi18)
(commit `5703f543f76746369f0a11e0d1635ac395b2efac`). Its image
`org.fedi.fedimintd.release` label is `0.11.1-fedi18`, while the typed DKG
