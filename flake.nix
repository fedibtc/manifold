{
  ...
  inputs = {
    ...
    fedimint.url = "github:fedibtc/fedimint/v0.12.0-fedi6";
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        buildPaths = [
          ...
          "docs/telemetry/fedimint-metrics-v0.12.0-fedi6.tsv"
        ...
        fedimintSourceRev = "c64017bd7c403d2f81dd29e1d2032a753f99150a";
        ...
        cloudFmanTelemetryMetricsInventory =
          pkgs.runCommand "cloud-fman-telemetry-metrics-inventory"
            ...
            ''
              ...
              manifest=${./docs/telemetry/fedimint-metrics-v0.12.0-fedi6.tsv}
