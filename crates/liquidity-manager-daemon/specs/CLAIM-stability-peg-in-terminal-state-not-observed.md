...
- **A4 (pin identity):** `flake.nix` exposes the locked Fedimint input as
  ...
  `fedibtc/fedimint@6b23752fbd8d21a875da9c7970d284411692c040` (release base
  `v0.11.2-fedi4`). The update from fedi18 and the hybrid-backend safety
  backports leave the wallet-client and
