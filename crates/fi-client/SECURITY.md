...
the shared scalar-version, FI-range, selected major/minor/vendor, size,
accepting-seats, and plan predicate into typed rejections; its
...
within and across compatible DKG cohorts is likewise a publisher claim;
